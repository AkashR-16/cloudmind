...
async def test_classify_intent_passes_history_to_gemini(mock_model_factory):
...
@pytest.mark.asyncio
@patch("agent.intent.get_aql_model")
async def test_classify_intent_works_without_history(mock_model_factory):
    mock_model = MagicMock()
    mock_model_factory.return_value = mock_model
    mock_model.generate_content.return_value = make_gemini_response(
        '{"intent": "resource_query", "entities": {}}'
    )
...
@pytest.mark.asyncio
@patch("agent.intent.get_aql_model")
async def test_classify_intent_with_empty_history(mock_model_factory):
    mock_model = MagicMock()
    mock_model_factory.return_value = mock_model
    mock_model.generate_content.return_value = make_gemini_response(
        '{"intent": "resource_query", "entities": {}}'
...
@pytest.mark.asyncio
@patch("agent.intent.get_aql_model")
async def test_classify_intent_only_uses_recent_history(mock_model_factory):
    ...
    # Oldest messages may be trimmed (only last 4 = 2 turns used)


@pytest.mark.asyncio
@patch("agent.intent.get_aql_model")
async def test_classify_intent_rds_query(mock_model_factory):
    mock_model = MagicMock()
    mock_model_factory.return_value = mock_model
    mock_model.generate_content.return_value = make_gemini_response(
        '{"intent": "security_query", "entities": {"resource_type": "aws_rds_instance"}}'
    )
...
@pytest.mark.asyncio
@patch("agent.intent.get_aql_model")
async def test_classify_intent_count_query(mock_model_factory):
    mock_model = MagicMock()
    mock_model_factory.return_value = mock_model
    mock_model.generate_content.return_value = make_gemini_response(
        '{"intent": "count_query", "entities": {"resource_type": "aws_vpc"}}'
    )
...
@pytest.mark.asyncio
@patch("agent.intent.get_aql_model")
async def test_classify_intent_iam_query(mock_model_factory):
    mock_model = MagicMock()
    mock_model_factory.return_value = mock_model
    mock_model.generate_content.return_value = make_gemini_response(
        '{"intent": "resource_query", "entities": {"resource_type": "aws_iam_role"}}'
    )
